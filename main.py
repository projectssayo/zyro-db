...
def info():
    return {
        ...
        "/update_password_via_token": "https://zyro-db.onrender.com/update_password_via_token?token=1aOf3c29YGAe9GZff5cd3aeaIYYZY5afI3eZ2AOaca3aYX&password=my_pass123",
    }
